...
- Rename SpectrumType to MeasurementXY and enforce the presence of variables 'x' and 'y'
- rename VariableType to MeasurementVariable and SelectorType to SpectrumSelector
...
- Rename SpectrumType to MeasurementXY and enforce the presence of variables 'x' and 'y' ([52123c0](https://www.github.com/cheminfo/common-spectrum/commit/52123c0b7c0fadd120f2fe5e82178b133442c131))
- rename VariableType to MeasurementVariable and SelectorType to SpectrumSelector ([f9bdc1f](https://www.github.com/cheminfo/common-spectrum/commit/f9bdc1f311ca6dd893740003389dd9942c03b6d3))
...
- add isMonotonic to all variables ([177c676](https://github.com/cheminfo/common-spectrum/commit/177c6760b18feda7cac092cb3db3c16469acc611))
...
- add min, max for variables and isMonotonic for x variable ([a019543](https://github.com/cheminfo/common-spectrum/commit/a019543ca8f03eb46c99a8c9308c8e76d086ce33))
